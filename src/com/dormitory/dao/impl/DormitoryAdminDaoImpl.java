...
import com.dormitory.dao.DormitoryAdminDao;
...
public class DormitoryAdminDaoImpl implements DormitoryAdminDao {
    ...
    public List<DormitoryAdmin> list() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                list.add(new DormitoryAdmin(id, username, password, name, gender,photo, telephone));
            }
    ...
    public Integer save(DormitoryAdmin dormitoryAdmin) {
        Connection connection = JDBCUtil.getConnection();
        String sql = "insert into dormitory_admin(username,password,name,gender,photo,telephone) values(?,?,?,?,?,?)";
        PreparedStatement statement = null;
        Integer result = null;
        try {
            statement = connection.prepareStatement(sql);
            ...
            statement.setString(5, dormitoryAdmin.getPhoto());
            statement.setString(6, dormitoryAdmin.getTelephone());
