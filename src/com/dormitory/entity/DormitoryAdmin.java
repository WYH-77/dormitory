...
public class DormitoryAdmin {
    ...
    public DormitoryAdmin(Integer id, String username, String password, String name, String gender,String photo, String telephone) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.name = name;
    ...
    public DormitoryAdmin(String username, String password, String name, String gender, String photo, String telephone) {
        this.username=username;
        this.password=password;
        this.name=name;
        this.gender=gender;
