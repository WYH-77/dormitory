...
public class DormitoryServiceImpl implements DormitoryService {
    ...
    public int getTotalCount(String key, String value) {
        return dormitoryDao.getTotalCount(key,value);
    }

    @Override
    public List<Dormitory> queryDormitoryByPage(int currentPage, int pageSize, String key, String value) {
        return dormitoryDao.queryDormitoryByPage(currentPage,pageSize,key,value);
    }
}
