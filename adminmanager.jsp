        ...
        <div class="col-sm-10">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <tbody>
                    <c:forEach items="${list}" var="dormitoryAdmin" varStatus="id">
                        <tr>
                            ...
                            <td><img src="photo/${dormitoryAdmin.photo}" width="32" height="32" alt="照片"></td>
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="/uploadFileServlet?identity=adminmanager" enctype="multipart/form-data" class="form-horizontal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel2">添加宿管信息</h4>
                                </div>
                                    ...
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <lable style="color:red;">*照片要小于10kb</lable>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel3">用户信息</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                ...
                <form method="post" action="/dormitoryAdmin?method=delete"
                      ...
                      id="form_data3" style="margin: 20px;">
...
<script>
    ...
    $('#delUserModal').on('show.bs.modal', function (event) {
        ...
        /*先查找id=id2的输入框,再设置input的value值为id*/
