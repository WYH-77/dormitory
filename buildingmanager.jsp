        ...
        <div class="col-sm-10">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <tbody>
                    <c:forEach items="${list}" var="building" varStatus="id">
                        <tr>
                            <td>${building.id}</td>
                            <td>${building.name}</td>
                ...
                <form method="post" action="/building?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data4" style="margin: 20px;">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel2">添加楼宇信息</h4>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">x</button>
                                    <h4 class="modal-title" id="myModalLabel4">用户信息</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel6">用户信息</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
